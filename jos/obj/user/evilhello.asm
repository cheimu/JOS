...
umain(int argc, char **argv)
{
  ...
  800040:	e8 6b 00 00 00       	call   8000b0 <sys_cputs>
}
...
sys_env_destroy(envid_t envid)
{
  ...
  80011d:	68 0a 1f 80 00       	push   $0x801f0a
  800122:	6a 23                	push   $0x23
  800124:	68 27 1f 80 00       	push   $0x801f27
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80017f:	68 0a 1f 80 00       	push   $0x801f0a
  800184:	6a 23                	push   $0x23
  800186:	68 27 1f 80 00       	push   $0x801f27
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001c1:	68 0a 1f 80 00       	push   $0x801f0a
  8001c6:	6a 23                	push   $0x23
  8001c8:	68 27 1f 80 00       	push   $0x801f27
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800203:	68 0a 1f 80 00       	push   $0x801f0a
  800208:	6a 23                	push   $0x23
  80020a:	68 27 1f 80 00       	push   $0x801f27
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800264:	68 0a 1f 80 00       	push   $0x801f0a
  800269:	6a 23                	push   $0x23
  80026b:	68 27 1f 80 00       	push   $0x801f27
...
sys_sysinfo(struct sysinfo *info)
{
  ...
  8002a5:	68 0a 1f 80 00       	push   $0x801f0a
  8002aa:	6a 23                	push   $0x23
  8002ac:	68 27 1f 80 00       	push   $0x801f27
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002e7:	68 0a 1f 80 00       	push   $0x801f0a
  8002ec:	6a 23                	push   $0x23
  8002ee:	68 27 1f 80 00       	push   $0x801f27
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800329:	68 0a 1f 80 00       	push   $0x801f0a
  80032e:	6a 23                	push   $0x23
  800330:	68 27 1f 80 00       	push   $0x801f27
...
sys_ipc_recv(void *dstva)
{
  ...
  80038d:	68 0a 1f 80 00       	push   $0x801f0a
  800392:	6a 23                	push   $0x23
  800394:	68 27 1f 80 00       	push   $0x801f27
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8004d8:	ba b4 1f 80 00       	mov    $0x801fb4,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  8004fa:	51                   	push   %ecx
  8004fb:	50                   	push   %eax
  8004fc:	68 38 1f 80 00       	push   $0x801f38
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80074f:	53                   	push   %ebx
  800750:	50                   	push   %eax
  800751:	68 79 1f 80 00       	push   $0x801f79
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800818:	53                   	push   %ebx
  800819:	50                   	push   %eax
  80081a:	68 95 1f 80 00       	push   $0x801f95
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8008c0:	53                   	push   %ebx
  8008c1:	50                   	push   %eax
  8008c2:	68 58 1f 80 00       	push   $0x801f58
...
00800a82 <devfile_write>:
{
  ...
  800ae2:	c3                   	ret    
	assert(r <= n);
  800ae3:	68 c4 1f 80 00       	push   $0x801fc4
  800ae8:	68 cb 1f 80 00       	push   $0x801fcb
  800aed:	68 98 00 00 00       	push   $0x98
  800af2:	68 e0 1f 80 00       	push   $0x801fe0
  800af7:	e8 11 06 00 00       	call   80110d <_panic>
	assert(r <= PGSIZE);
  800afc:	68 eb 1f 80 00       	push   $0x801feb
  800b01:	68 cb 1f 80 00       	push   $0x801fcb
  800b06:	68 99 00 00 00       	push   $0x99
  800b0b:	68 e0 1f 80 00       	push   $0x801fe0
...
00800b15 <devfile_read>:
{
  ...
  800b6a:	c3                   	ret    
	assert(r <= n);
  800b6b:	68 c4 1f 80 00       	push   $0x801fc4
  800b70:	68 cb 1f 80 00       	push   $0x801fcb
  800b75:	6a 7c                	push   $0x7c
  800b77:	68 e0 1f 80 00       	push   $0x801fe0
  800b7c:	e8 8c 05 00 00       	call   80110d <_panic>
	assert(r <= PGSIZE);
  800b81:	68 eb 1f 80 00       	push   $0x801feb
  800b86:	68 cb 1f 80 00       	push   $0x801fcb
  800b8b:	6a 7d                	push   $0x7d
  800b8d:	68 e0 1f 80 00       	push   $0x801fe0
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800c54:	68 f7 1f 80 00       	push   $0x801ff7
  800c59:	53                   	push   %ebx
...
00800cb4 <_pipeisclosed>:
{
  ...
  800cf7:	50                   	push   %eax
  800cf8:	53                   	push   %ebx
  800cf9:	68 fe 1f 80 00       	push   $0x801ffe
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800f96:	68 16 20 80 00       	push   $0x802016
  800f9b:	53                   	push   %ebx
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801130:	53                   	push   %ebx
  801131:	50                   	push   %eax
  801132:	68 24 20 80 00       	push   $0x802024
  ...
  801169:	68 0f 20 80 00       	push   $0x80200f
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8012c7:	0f be 80 47 20 80 00 	movsbl 0x802047(%eax),%eax
  8012ce:	50                   	push   %eax
...
0080131a <vprintfmt>:
{
  ...
  80143a:	50                   	push   %eax
  80143b:	68 dd 1f 80 00       	push   $0x801fdd
  801440:	53                   	push   %ebx
  801441:	56                   	push   %esi
  ...
  801456:	52                   	push   %edx
  801457:	68 5f 20 80 00       	push   $0x80205f
  80145c:	53                   	push   %ebx
  80145d:	56                   	push   %esi
  ...
  8014b7:	eb 14                	jmp    8014cd <vprintfmt+0x1b3>
				p = "(null)";
  8014b9:	bf 58 20 80 00       	mov    $0x802058,%edi
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801beb:	68 cb 1f 80 00       	push   $0x801fcb
