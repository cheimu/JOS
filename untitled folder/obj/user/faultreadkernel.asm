	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ef:	0f be 80 31 1f 80 00 	movsbl 0x801f31(%eax),%eax
  8001f6:	50                   	push   %eax
...
00800242 <vprintfmt>:
{
  ...
  80028d:	ff 24 85 80 20 80 00 	jmp    *0x802080(,%eax,4)
  ...
  800357:	8b 04 85 e0 21 80 00 	mov    0x8021e0(,%eax,4),%eax
  80035e:	85 c0                	test   %eax,%eax
  800360:	74 1c                	je     80037e <vprintfmt+0x13c>
				printfmt(putch, putdat, "%s", p);
  800362:	50                   	push   %eax
  800363:	68 11 23 80 00       	push   $0x802311
  800368:	53                   	push   %ebx
  800369:	56                   	push   %esi
  ...
  80037e:	52                   	push   %edx
  80037f:	68 49 1f 80 00       	push   $0x801f49
  800384:	53                   	push   %ebx
  800385:	56                   	push   %esi
  ...
  8003df:	eb 14                	jmp    8003f5 <vprintfmt+0x1b3>
				p = "(null)";
  8003e1:	bf 42 1f 80 00       	mov    $0x801f42,%edi
...
sys_env_destroy(envid_t envid)
{
  ...
  800ad5:	68 3f 22 80 00       	push   $0x80223f
  800ada:	6a 23                	push   $0x23
  800adc:	68 5c 22 80 00       	push   $0x80225c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b37:	68 3f 22 80 00       	push   $0x80223f
  800b3c:	6a 23                	push   $0x23
  800b3e:	68 5c 22 80 00       	push   $0x80225c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bbb:	68 3f 22 80 00       	push   $0x80223f
  800bc0:	6a 23                	push   $0x23
  800bc2:	68 5c 22 80 00       	push   $0x80225c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c1c:	68 3f 22 80 00       	push   $0x80223f
  800c21:	6a 23                	push   $0x23
  800c23:	68 5c 22 80 00       	push   $0x80225c
...
sys_sysinfo(struct sysinfo *info)
{
  ...
  800c5d:	68 3f 22 80 00       	push   $0x80223f
  800c62:	6a 23                	push   $0x23
  800c64:	68 5c 22 80 00       	push   $0x80225c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c9f:	68 3f 22 80 00       	push   $0x80223f
  800ca4:	6a 23                	push   $0x23
  800ca6:	68 5c 22 80 00       	push   $0x80225c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800ce1:	68 3f 22 80 00       	push   $0x80223f
  800ce6:	6a 23                	push   $0x23
  800ce8:	68 5c 22 80 00       	push   $0x80225c
...
sys_ipc_recv(void *dstva)
{
  ...
  800d45:	68 3f 22 80 00       	push   $0x80223f
  800d4a:	6a 23                	push   $0x23
  800d4c:	68 5c 22 80 00       	push   $0x80225c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800e90:	ba e8 22 80 00       	mov    $0x8022e8,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  800eb2:	51                   	push   %ecx
  800eb3:	50                   	push   %eax
  800eb4:	68 6c 22 80 00       	push   $0x80226c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801107:	53                   	push   %ebx
  801108:	50                   	push   %eax
  801109:	68 ad 22 80 00       	push   $0x8022ad
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8011d0:	53                   	push   %ebx
  8011d1:	50                   	push   %eax
  8011d2:	68 c9 22 80 00       	push   $0x8022c9
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801278:	53                   	push   %ebx
  801279:	50                   	push   %eax
  80127a:	68 8c 22 80 00       	push   $0x80228c
...
0080143a <devfile_write>:
{
  ...
  80149a:	c3                   	ret    
	assert(r <= n);
  80149b:	68 f8 22 80 00       	push   $0x8022f8
  8014a0:	68 ff 22 80 00       	push   $0x8022ff
  8014a5:	68 98 00 00 00       	push   $0x98
  8014aa:	68 14 23 80 00       	push   $0x802314
  8014af:	e8 11 06 00 00       	call   801ac5 <_panic>
	assert(r <= PGSIZE);
  8014b4:	68 1f 23 80 00       	push   $0x80231f
  8014b9:	68 ff 22 80 00       	push   $0x8022ff
  8014be:	68 99 00 00 00       	push   $0x99
  8014c3:	68 14 23 80 00       	push   $0x802314
...
008014cd <devfile_read>:
{
  ...
  801522:	c3                   	ret    
	assert(r <= n);
  801523:	68 f8 22 80 00       	push   $0x8022f8
  801528:	68 ff 22 80 00       	push   $0x8022ff
  80152d:	6a 7c                	push   $0x7c
  80152f:	68 14 23 80 00       	push   $0x802314
  801534:	e8 8c 05 00 00       	call   801ac5 <_panic>
	assert(r <= PGSIZE);
  801539:	68 1f 23 80 00       	push   $0x80231f
  80153e:	68 ff 22 80 00       	push   $0x8022ff
  801543:	6a 7d                	push   $0x7d
  801545:	68 14 23 80 00       	push   $0x802314
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80160c:	68 2b 23 80 00       	push   $0x80232b
  801611:	53                   	push   %ebx
...
0080166c <_pipeisclosed>:
{
  ...
  8016af:	50                   	push   %eax
  8016b0:	53                   	push   %ebx
  8016b1:	68 32 23 80 00       	push   $0x802332
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80194e:	68 4a 23 80 00       	push   $0x80234a
  801953:	53                   	push   %ebx
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801ae8:	53                   	push   %ebx
  801ae9:	50                   	push   %eax
  801aea:	68 58 23 80 00       	push   $0x802358
  ...
  801b21:	68 43 23 80 00       	push   $0x802343
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801bea:	68 7c 23 80 00       	push   $0x80237c
  801bef:	68 ff 22 80 00       	push   $0x8022ff
  801bf4:	6a 48                	push   $0x48
  801bf6:	68 a0 23 80 00       	push   $0x8023a0
